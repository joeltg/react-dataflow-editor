...
exports.updateNodes = exports.handleResize = void 0;
...
const handleResize = (ref, entries) => {
    for (const { target, contentRect } of entries) {
        ...
        const width = contentRect.width + 2 * utils_js_1.blockMarginX;
        const height = contentRect.height + 2 * utils_js_1.blockMarginY;
