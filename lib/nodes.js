...
import { getKey, getPortOffsetY, getSourcePosition, getTargetPosition, toTranslate, snap, blockWidth, makeClipPath, portHeight, getTargetIndex, getSourceIndex, } from "./utils.js";
    ...
    return () => {
        ref.nodes
            ...
            groups
                ...
                const w = blockWidth;
                const h = Math.max(portHeight, inputCount * portHeight, outputCount * portHeight);
