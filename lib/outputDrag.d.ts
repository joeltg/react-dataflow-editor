...
export declare function makeOutputDragBehavior<S extends Schema>(context: EditorContext, kinds: Kinds<S>, dispatch: (action: EditorAction<S>) => void): DragBehavior<SVGCircleElement, unknown, OutputDragSubject<S>>;
