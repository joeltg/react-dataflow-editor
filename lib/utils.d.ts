...
import type { Schema, Position, Kinds, GetInputs, GetOutputs, EditorState, Target, Source, Focus } from "./state.js";
...
export declare function place(context: EditorContext, { x, y }: Position, offset?: [number, number]): [number, number];
...
export declare function getSourcePosition<S extends Schema>(context: EditorContext, kinds: Kinds<S>, { id, output }: Source<S>): [number, number];
export declare function getTargetPosition<S extends Schema>(context: EditorContext, kinds: Kinds<S>, { id, input }: Target<S>): [number, number];
...
export declare const snap: ({ unit, height }: EditorContext, [x, y]: [number, number]) => Position;
