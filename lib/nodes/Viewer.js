...
import { updateNodes } from "./readonly.js";
...
export function Viewer({ unit = defaultCanvasUnit, height = defaultCanvasHeight, ...props }) {
    return (React.createElement("div", { className: "viewer" },
        React.createElement(Canvas, { unit: unit, height: height, kinds: props.kinds, graph: props.graph, onFocus: props.onFocus, decorateEdges: props.decorateEdges, decorateNodes: props.decorateNodes })));
}
