...
import { nodeHeaderHeight, nodeWidth, getKey, makeClipPath, portHeight, toTranslate, } from "../utils.js";
export const appendNodes = (ref, enter, attachInputs, attachOutputs) => {
    ...
    groups
        ...
        const w = nodeWidth;
        const h = nodeHeaderHeight + portHeight * Math.max(inputCount, outputCount);
