...
export declare function makeNodeDragBehavior<S extends Schema>(context: EditorContext, kinds: Kinds<S>, dispatch: (action: EditorAction<S>) => void): DragBehavior<SVGGElement, undefined, NodeDragSubject>;
export {};
